...
norm_method = 'inst'                    # const:按照训练集分布归一化, inst:实例归一化。仅针对RangeClipNorm方法
data_preprocessor_normalize = False     # 是否启用mmseg的data_preprocessor归一化（归一化可以在自定义的RangeClipNorm中进行）
stretch_CornerFactor=0.5                # 平滑边角拉伸系数
...
distort_amplitude=0.5                     # 扭曲的振幅，沿中心向四周仿射的正弦振幅
distort_frequency=2                     # 扭曲的频率，沿中心向四周仿射的正弦频率
