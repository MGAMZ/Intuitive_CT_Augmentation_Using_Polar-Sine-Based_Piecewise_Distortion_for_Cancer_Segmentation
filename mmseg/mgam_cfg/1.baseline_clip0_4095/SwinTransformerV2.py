...
contrast = 1
brightness = 0
(mean, std) = (561.54, 486.59) # after clip to (0,4095): (10.87, 1138.37)
...
train_pipeline = [
    ...
    dict(type='CTImgEnhance', contrast=contrast, brightness=brightness, norm_method=norm_method, mean=mean, std=std),	# CT影像 纵隔部位加强
...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', by_epoch=False, interval=val_interval*4, max_keep_ckpts=1),
...
load_from = None
resume = True
work_dir = './work_dirs/BASELINE_SwinTransformerV2'
tta_model = None
