...
meta_ckpt = r"C:\mgam\mgam_CT\2023_Med_CQK\2024-02-04_00-50-29.pickle"
data_task = 'RelativeIndexLearning'

# SETTING: sample augment
samples_per_scan = 20 if not debug else 1
...
relative_position_std = 100             # 相对位置标准差
...
stretch_CornerFactor=0                  # 平滑边角拉伸系数
stretch_GlobalFactor=1                  # 全局拉伸系数，相当于zoom
stretch_workers=4                       # 自定义的多进程实现, 与dataloader的num_workers无关
distort_global_rotate=1                 # 全局旋转角度，随机介于[-90x°, 90x°]
distort_amplitude=1                     # 扭曲的振幅，沿中心向四周仿射的正弦振幅
